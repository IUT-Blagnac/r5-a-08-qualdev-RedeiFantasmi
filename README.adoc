...
.Extrait rapport cukedoctor pour cucumber_demo https://htmlpreview.github.io/?https://github.com/IUT-Blagnac/r5-a-08-qualdev-RedeiFantasmi/blob/v4.0/cucumber_demo/target/cukedoctor/documentation.html[(appuyer ici pour voir le rapport complet)]
